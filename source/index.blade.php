...
<section class="container px-6 py-10 mx-auto space-y-4 max-w-xl text-lg md:py-12">
    ...
    <p>In the <a href="https://store.steampowered.com/news/app/730/view/4458095069430284352" class="text-orange-500 underline" target="_blank">November 14, 2024</a> update, Valve announced a new feature for Counter-Strike 2: <span class="font-semibold">Map Guides</span>. This is a way to store and share grenade line-ups.</p>
    ...
    <p>If you'd like to get involved, please email me at <a href="mailto:hi@n1c.dev" class="text-orange-500 underline" target="_blank">hi@n1c.dev</a> or start a discussion on the <a href="https://github.com/n1c/csmapguides/discussions" class="text-orange-500 underline" target="_blank">Github repo</a>.</p>
</section>
@endsection
